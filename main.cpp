...
int main() {
	...
	// iLL->insertHead(10); //Inserts Head
	// cout << iLL->toString() << endl;
	// iLL->insertTail(30); //Inserts tail
	// cout << iLL->toString() << endl;
	// iLL->insertAfter(10, 15); //Inserts 15 after 10 - 10 15 30 -
	// cout << iLL->toString() << endl;
	// iLL->insertAfter(15, 20); //inserts 20 after 15  - 10 15 20 25 -
	// cout << iLL->toString() << endl;
	// iLL->insertAfter(20, 25); //Inserts 25 after 20 - 10 15 20 25 30 -
	// cout << iLL->toString() << endl;
	// iLL->remove(20); //Removes 20 - 10 15 25 30 - 
	// cout << iLL->toString() << endl;
	// iLL->remove(10); //Removes head 10 - 15 25 30 -
	// cout << iLL->toString() << endl;
	// iLL->insertAfter(15, 25); //Tries inserting 25 after 15 but it doesn't since it already exists - 15 25 30 -
	// cout << iLL->toString() << endl << endl;
	// // iLL->clear(); // Deletes everything
	// // cout << iLL->toString() << endl;
	// cout << iLL->at(1) << endl;
